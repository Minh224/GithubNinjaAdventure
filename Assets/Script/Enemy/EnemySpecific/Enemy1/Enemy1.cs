...
public class Enemy1 : Entini
{
    ...
    public override void Start()
    {
        ...
        meleeAttackState = new E1_MeleeAttackState(this, stateMachine, "meleeAttack", meleeAttackPosition, melleAttackStateData, this);
        stunState = new E1_StunState(this, stateMachine, "stun", stunStateData, this);
        deadState = new E1_DeadState(this, stateMachine, "stun", deadStateData, this);
